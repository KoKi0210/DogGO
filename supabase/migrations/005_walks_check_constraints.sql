-- Add CHECK constraints to walks table for server-side validation
-- Prevents clients from submitting unreasonable values
...
-- Add CHECK constraint to reviews for rating validation
